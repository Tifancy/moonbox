...
import edp.moonbox.core.rest.routing.Router
import edp.moonbox.core.rest.services.{ComputeService, DataFetchService, ServiceImpl}
...
class RestServer(host: String,
	...
	override val computer: ComputeService = new ComputeService(computerRef, executionContext, Timeout(30 seconds))
	override val dataGetter: DataFetchService = new DataFetchService(dataGetterRef, executionContext, Timeout(120 seconds))
