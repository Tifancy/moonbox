...
import edp.moonbox.common.RedisCacheClient
...
/**
  * Created by edp on 17/6/16.
  */
class DataFetchActor(host: String, port: Int) extends Actor {
    ...
    override def receive: Receive = {
        case  FetchData(jobId, offset, size) =>
	        ...
	        dataFuture.onComplete {
		        case Success(data) =>
			        sender() ! FetchDataResponse(jobId, Some(data), "")
		        case Failure(e) =>
			        sender() ! FetchDataResponse(jobId, None, e.getMessage)
	        }
    }
